...
static void add_star(AppState *app, const char *name, double ra_h, double ra_m, double ra_s, char dec_sign, double dec_d, double dec_m, double dec_s, double mag, int const_id) {
    ...
    // Calculate declination magnitude
...
void init_data(AppState *app) {
    ...
    add_star(app, "Mintaka", 5, 32, 0.4, '-', 0, 17, 57, 2.23, 2);
